...
const expected = {
  de: [
    ...
    'jede/n/s Werktag',
    'jede/n/s 2 Minuten',
    'jede/n/s Woche am Sonntag bis November 10, 2012',
  ...
  es: [
    ...
    'cada 2 minutos',
    'cada semana en domingo hasta noviembre 10, 2012',
  ...
  hi: [
    ...
    'हर सप्ताह का दिन',
    'हर 2 मिनट',
    'हर सप्ताह को रविवार तक नवंबर 10, 2012',
  ...
  ar: [
    ...
    'كل 2 دقائق',
    'كل أسبوع في الأحد حتى نوفمبر 10, 2012',
  ...
  he: [
    ...
    'כל יום חול',
    'כל 2 דקות',
    'כל שבוע ב יום ראשון עד נובמבר 10, 2012',
  ...
  fr: [
    ...
    'chaque 2 minutes',
    "chaque semaine le dimanche jusqu'au novembre 10, 2012",
