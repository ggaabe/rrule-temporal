...
// These are not defined in the RFC, but we will support it where possible
describe('BYWEEKNO non-rfc frequencies', () => {
  it('testMonthlyByWeekNo', () => {
    const rule = new RRuleTemporal({
      freq: 'MONTHLY',
      count: 3,
      byWeekNo: [20],
  ...
  it('testMonthlyByWeekNoAndWeekDay', () => {
    // That's a nice one. The first days of week number one
    // may be in the last year.
    const rule = new RRuleTemporal({
      freq: 'MONTHLY',
  ...
  it('testMonthlyByWeekNoAndWeekDayLarge', () => {
    // Another nice test. The last days of week number 52/53
    // may be in the next year.
    const rule = new RRuleTemporal({
      freq: 'MONTHLY',
  ...
  it('testMonthlyByWeekNoAndWeekDayLast', () => {
    const rule = new RRuleTemporal({
      freq: 'MONTHLY',
      count: 3,
      byWeekNo: [-1],
